<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="UpdateStudentName.aspx.cs" Inherits="MUOffLoad.UpdateStudentName" %>
        ...
        <asp:panel runat="server" ID="pnlStudentDataUpdate" Visible="False" CssClass="panel panel-info">
                ...
                <div class="panel-body">
                    <table class="table">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtfirstStudentName" CssClass="form-control" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                                                <tr>
                            <td>Student Last Name</td>
                            <td>
                                <asp:TextBox ID="txtlastStudentName" CssClass="form-control" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                     </table>
                </div>
                <div class="panel-footer">
                    <div style="text-align:right">
                        ...
                        <asp:Button ID="btnSubmitStudent" runat="server" Text="Submit" CssClass="btn btn-primary" OnClick="btnSubmitStudent_Click" />
