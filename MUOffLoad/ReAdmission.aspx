<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ReAdmission.aspx.cs" Inherits="MUOffLoad.ReAdmission" %>
        ...
        <asp:panel runat="server" ID="pnlStudentDataUpdate" Visible="False" CssClass="panel panel-info">
                <div class="panel-footer">
                    ...
                    <div style="text-align:right">
                        <asp:Button ID="btnRepStudent" runat="server" CssClass="btn btn-primary" OnClick="btnRepStudent_Click" Text="Regular Student" />
                        <asp:Button ID="btnSubmitStudent" runat="server" Text="Regular Student" CssClass="btn btn-primary" OnClick="btnSubmitStudent_Click" />
                    </div>
                </div>
        </asp:panel>
</asp:Content>
