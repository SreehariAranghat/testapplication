<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="UpdateStudentCollege.aspx.cs" Inherits="MUOffLoad.UpdateStudentCollege" %>
    ...
    <asp:panel runat="server" ID="pnlStudentDetails" Visible="False" CssClass="panel panel-info">
     ...
     <asp:panel runat="server" ID="pnlStudentDataUpdate" Visible="False" CssClass="panel panel-info">
                ...
                <div class="panel-body">
                    <table class="table">
                        <tr>
                            <td>Current College Code</td>
                            <td>
                                <asp:TextBox ID="txtCurrentCollegeCode" CssClass="form-control" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                     </table>
                </div>
