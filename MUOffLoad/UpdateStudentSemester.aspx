<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="UpdateStudentSemester.aspx.cs" Inherits="MUOffLoad.UpdateStudentSemester" %>
                ...
                <div class="panel-body">
                    <table class="table">
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtStudentSemester" CssClass="form-control" runat="server"></asp:TextBox>
                            </td>
                        </tr>
                     </table>
                </div>
