...
namespace MUOffLoad
{
    public partial class UpdateStudentName : System.Web.UI.Page
    {
        ...
        protected void btnSearchStudent_Click(object sender, EventArgs e)
        {
            if(!string.IsNullOrEmpty(txtRegisterNumber.Text))
            {
                ...
                if(student!= null)
                {
                    ...
                    txtfirstStudentName.Text = student.FirstName;
                    txtlastStudentName.Text = student.LastName;
                }
                else
                {
        ...
        protected void btnSubmitStudent_Click(object sender, EventArgs e)
        {
            ...
            if(!(string.IsNullOrEmpty(txtfirstStudentName.Text) || string.IsNullOrEmpty(txtlastStudentName.Text)))
            {
                var student = entities.Students.FirstOrDefault(s => s.RegisterNumber == txtRegisterNumber.Text);
                student.FirstName = txtfirstStudentName.Text.ToString();
                student.LastName = txtlastStudentName.Text.ToString();
